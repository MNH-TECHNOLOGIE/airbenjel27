...
export const metadata: Metadata = {
  title: "Basketball - Bientôt disponible",
  description: "La collection basketball arrive bientôt. Restez connectés.",
};
        ...
        <div className="mx-auto w-full max-w-7xl px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-gradient-to-br from-white via-white to-gray-50 p-6 text-center shadow-lg sm:p-8">
            ...
            <p className="mt-3 text-base text-gray-600 sm:text-lg">
              La collection basketball est en préparation. Découvrez bientôt des
              équipements officiels et des pièces exclusives.
            </p>
